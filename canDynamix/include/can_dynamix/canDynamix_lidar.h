#ifndef CANDYNAMIX_LIDAR_H
#define CANDYNAMIX_LIDAR_H
...
class canDynamix_lidar
{
  ...
  public:
	  ...
	  //bool controlLoop();
	  int is_in_tunnel;
	  can_dynamix::cmdVelMsg cmdVelMsg;
